	...
	public static void main(String[] args) {
		...
		switch(ano) {
			...
			case 2021:
				...
				break;
			case 2022:
				System.out.println("\nEste é o ano atual o salário deste funcionário será reajustado no próximo ano");
				break;
				default:
					System.out.println("\nAno inválido, digite um ano de 2015 até 2022.");
		}
		if (ano >= 2022 || ano < 2015) {
			
		}else
			
		System.out.printf("\nO salário atual em 2022 deste funcionário é %.2f", sAtual);
